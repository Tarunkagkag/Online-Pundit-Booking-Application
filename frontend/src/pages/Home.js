...
function Home() {
  ...
  // ✅ Fetch festivals & testimonials from backend
  useEffect(() => {
    ...
    <div className={styles.container}>
      ...
      <div className="w-100 text-center pt-2">
        <div className="position-relative">
          <img src={image[index]} alt={`Slide ${index + 1}`} className={styles.image} style={{ width: "100%" }} />
        ...
        <div className="container mt-4">
          <div className="row">
            {[
              {
                 name: "Ganesh Pooja",
                img: "https://images.news18.com/ibnlive/uploads/2025/08/image-2025-08-97a1b678f146274e432f9d798b39b7d4.jpg",
                link: "/ganesh-pooja",
              },
              {
                name: "Lakshmi Pooja",
                img: "https://cdn.pixabay.com/video/2023/11/11/188672-883619720_tiny.jpg",
               link: "/lakshmi-pooja",
               },
               {
                 name: "Satyanarayan Pooja",
                 img: "https://static.toiimg.com/thumb/msid-91551097,imgsize-73708,width-400,resizemode-4/91551097.jpg",
                 link: "/satyanarayan-pooja",
               },
               {
                 name: "Rudrabhishek",
                 img: "https://d18guwlcxyb2ak.cloudfront.net/wp-content/uploads/2024/11/25155902/IMG-20241119-WA0007.jpg",
                 link: "/rudrabhishek",
               },
               {
                 name: "Navagraha Pooja",
                 img: "https://cdn.shopify.com/s/files/1/0901/3588/8184/files/Navagraha-1536x864_jpg.webp?v=1740132210",
                 link: "/navagraha-pooja",
               },
               {
                 name: "Maha Mrityunjaya Pooja",
                 img: "https://cdn.99pandit.com/images/blogsimg/Maha-Mrityunjaya-Homam-1.webp",
                 link: "/mahamrityunjaya-pooja",
              },
             ].map((pooja, i) => (
               <div className="col-md-4 mb-4 text-center" key={i}>
                 ...
                 >
                   <img
                     src={pooja.img}
                     alt={pooja.name}
                     className={`img-fluid ${styles.poojaImage}`}
                     style={{
                       height: "200px",
                       objectFit: "cover",
                       width: "100%",
...
>
  ...
  <div className="container">
    ...
    <div className="row">
      {[ 
        {
          title: "Importance of Ganesh Pooja",
          snippet: "Ganesh Pooja helps remove obstacles and brings prosperity. Learn the rituals, timings, and benefits.The festival begins on the fourth day of the Hindu month. ",
          img: "https://images.news18.com/ibnlive/uploads/2025/08/image-2025-08-97a1b678f146274e432f9d798b39b7d4.jpg",
          link: "/blog/ganesh-pooja"
        },
        {
          title: "Benefits of Lakshmi Pooja",
          snippet: "Lakshmi Pooja invites wealth and abundance into your life. Discover how performing it with devotion changes your energy.",
          img: "https://cdn.pixabay.com/video/2023/11/11/188672-883619720_tiny.jpg",
          link: "/blog/lakshmi-pooja"
        },
        {
          title: "Power of Maha Mrityunjaya Pooja",
          snippet: "A powerful ritual for health, protection, and spiritual growth. Understand the significance of Maha Mrityunjaya Mantra.",
          img: "https://cdn.99pandit.com/images/blogsimg/Maha-Mrityunjaya-Homam-1.webp",
          link: "/blog/mahamrityunjaya-pooja"
        },
